...
const PROFESSION_TYPES = [
  ...
  "Consultanți în construcții",
  "Contabili autorizați și experți financiari",
  "Avocați",
  "Notari publici",
  "Auditori financiari",
  "Consultanți fiscali",
  "Administratori judiciari și lichidatori",
  "Răspundere civilă generală",
  "Răspundere pentru prestatori de servicii",
  "Răspundere chiriaș față de proprietar",
  "Răspundere proprietar față de chiriaș",
  "Răspundere angajator față de angajați",
  "Răspundere producător",
  "Răspundere administrator și director executiv",
  "Altă profesie / răspundere profesională",
];
...
export default function RaspundereProfesionalaPage() {
  ...
  const set = useCallback(<K extends keyof RPForm>(field: K, value: RPForm[K]) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("/api/raspundere-profesionala/submit", {
        method: "POST",
    ...
    return (
      <section className="mx-auto max-w-3xl px-4 pt-24 pb-8 text-center">
        ...
        <p className="mt-2 text-gray-500">
          Un consultant vă va contacta în cel mai scurt timp cu oferta de asigurare de răspundere profesională.
        </p>
        <button
          type="button"
  ...
  const steps = [
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm space-y-4">
            ...
            <div className="border-t border-gray-100 pt-4">
              <div className="mb-3 flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-gray-500">Date solicitant</span>
              </div>
            ...
            <div className="border-t border-gray-100 pt-4">
              ...
              <textarea
                ...
                placeholder="Informații suplimentare despre activitatea profesională..."
              />
            </div>
          </div>
    ...
    /* ────── Step 2: DNT ────── */
    {
      ...
      content: (
        <DntChoice
          productLabel="Răspundere Profesională"
        ...
        <div className="mx-auto max-w-2xl space-y-4">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <div><span className="text-gray-400">Tip răspundere:</span> <span className="font-medium text-gray-700">{form.professionType}</span></div>
              <div><span className="text-gray-400">Tip solicitant:</span> <span className="font-medium text-gray-700">{form.ownerType === "PF" ? "Persoană fizică" : "Persoană juridică"}</span></div>
              <div>
                <span className="text-gray-400">Nume:</span>{" "}
                <span className="font-medium text-gray-700">
                  {form.ownerType === "PF" ? `${form.lastName} ${form.firstName}` : form.companyName}
                </span>
              </div>
              {form.ownerType === "PJ" && (
              ...
              {form.ownerType === "PF" && (
                <div><span className="text-gray-400">CNP:</span> <span className="font-medium text-gray-700">{form.cnp}</span></div>
              )}
          ...
          >
            ...
            <span className="text-sm text-gray-700">
              ...
              {" "}în vederea primirii ofertei de asigurare de răspundere profesională.
            </span>
          </button>
              ...
              <div className="mx-4 max-w-lg rounded-xl bg-white p-6 shadow-xl">
                ...
                <div className="max-h-64 overflow-y-auto text-sm text-gray-600 space-y-2">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>Generării ofertei de asigurare de răspundere profesională solicitate</li>
